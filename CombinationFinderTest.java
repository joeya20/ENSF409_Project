...
public class CombinationFinderTest {
    ...
    public void CombinationFinderNoSolutionsTest() {
        ...
        ArrayList<InventoryEntity> testData = new ArrayList<InventoryEntity>() {{
            add(new InventoryEntity("C001", "mesh", new boolean[]{true, true, false}, 50, "M001"));
            add(new InventoryEntity("C002", "mesh", new boolean[]{true, true, false}, 30, "M001"));
            add(new InventoryEntity("C003", "mesh", new boolean[]{true, false, true}, 25, "M001"));
            add(new InventoryEntity("C004", "mesh", new boolean[]{false, true, false}, 10, "M001"));
        }};
    ...
    public void CombinationFinderFilterInputTest() {
        ...
        ArrayList<InventoryEntity> testData = new ArrayList<InventoryEntity>() {{
            add(new InventoryEntity("C002", "kneel", new boolean[]{true, false, false, true}, 30, "M001"));
            add(new InventoryEntity("C001", "exec", new boolean[]{true, true, true, true}, 7, "M001"));
            add(new InventoryEntity("C003", "kneel", new boolean[]{false, false, true, false}, 15, "M001"));
            add(new InventoryEntity("C004", "kneel", new boolean[]{false, true, false, false}, 15, "M001"));
        }};
    ...
    public void CombinationFinderTestOptimality() {
        ...
        ArrayList<InventoryEntity> testData = new ArrayList<InventoryEntity>() {{
            add(new InventoryEntity("Z001", "large", new boolean[]{true, true, false}, 50, "M001"));
            add(new InventoryEntity("Z002", "large", new boolean[]{true, false, true}, 50, "M001"));
            add(new InventoryEntity("Z003", "large", new boolean[]{true, true, true}, 100, "M001"));
            add(new InventoryEntity("Z004", "large", new boolean[]{false, true, true}, 50, "M001"));
        }};
    ...
    public void CombinationFinderTestProjectExample() {
        ...
        ArrayList<InventoryEntity> testData = new ArrayList<InventoryEntity>() {{
            add(new InventoryEntity("C1320", "Kneeling", new boolean[]{true, false, false, false}, 50, "002"));
            add(new InventoryEntity("C3405", "Task", new boolean[]{true, true, false, false}, 100, "003"));
            add(new InventoryEntity("C9890", "Mesh", new boolean[]{false, true, false, true}, 50, "003"));
            add(new InventoryEntity("C7268", "Executive", new boolean[]{false, false, true, false}, 75, "004"));
            add(new InventoryEntity("C0942", "Mesh", new boolean[]{true, false, true, true}, 175, "005"));
            add(new InventoryEntity("C4839", "Ergonomic", new boolean[]{false, false, false, true}, 50, "002"));
            add(new InventoryEntity("C2483", "Executive", new boolean[]{true, true, false, false}, 175, "002"));
            add(new InventoryEntity("C5789", "Ergonomic", new boolean[]{true, false, false, true}, 125, "003"));
            add(new InventoryEntity("C3819", "Kneeling", new boolean[]{false, false, true, false}, 75, "005"));
            add(new InventoryEntity("C5784", "Executive", new boolean[]{true, false, false, true}, 150, "004"));
            add(new InventoryEntity("C6748", "Mesh", new boolean[]{true, false, false, false}, 75, "003"));
            add(new InventoryEntity("C0914", "Task", new boolean[]{false, false, true, true}, 50, "002"));
            add(new InventoryEntity("C1148", "Task", new boolean[]{true, false, true, true}, 125, "003"));
            add(new InventoryEntity("C5409", "Ergonomic", new boolean[]{true, true, true, false}, 200, "003"));
            add(new InventoryEntity("C8138", "Mesh", new boolean[]{false, false, true, false}, 75, "005"));
        }};
